 ...
 */
class getSpecialtyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SpecialtyRepository' shared autowired service.
     *
     * @return \App\Repository\SpecialtyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SpecialtyRepository.php';

        return $container->privates['App\\Repository\\SpecialtyRepository'] = new \App\Repository\SpecialtyRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
