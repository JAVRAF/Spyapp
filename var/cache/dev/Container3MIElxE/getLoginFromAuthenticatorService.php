...
class getLoginFromAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'LoginFromAuthenticator.php';

        return $container->privates['App\\Security\\LoginFromAuthenticator'] = new \App\Security\LoginFromAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
